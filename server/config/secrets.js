...
export const arkhamApi = {
  access_token: process.env.ARKHAM_ACCESS_TOKEN || 'qykfRJKxuk9foHfv1ZznF3kNdjzfn8DWvylgd5Ga',
  sync_url: process.env.ARKHAM_SYNC_URL || 'https://w1wjvbt019.execute-api.us-east-1.amazonaws.com/arkham/synchronize/v1/test',
  score_url: process.env.ARKHAM_SCORE_URL || 'https://haiy3h12e8.execute-api.us-east-1.amazonaws.com/arkham/score/v1/test',
}
