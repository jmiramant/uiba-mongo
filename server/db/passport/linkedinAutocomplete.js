...
export default (req, accessToken, refreshToken, profile, done) => {
  ...
  console.log(req)
  const user = req.user
  const updatedProf = new Profile();
  setDefaultProfileFields(updatedProf, profile, user._id);
  setDefaultUserFields(user, updatedProf, accessToken)
  user.profile_id = updatedProf._id;
