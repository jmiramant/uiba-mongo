...
class About extends Component {
  ...
  componentDidMount() {
    mixpanelURLTrack('ABOUT[load]:init');
  }
      ...
      <div className={cx('about')}>
        <div className={cx('container')}>
          <div className={cx('paper')} >
            ...
            <p className={cx('manifesto')}>There's no one place I can go and learn about every possible career path and understand all the options, all the possibilities tailored specifically to me.</p>
            <p className={cx('manifesto')}>There's no one place I can go and understand how qualified I am for a given career path and find recommendations about what I need to develop and learn to achieve my goals.</p>
            <p className={cx('manifesto')}>There's no one place I can go to learn from the wisdom of other that have traveled career paths of interest to me or where I can share my own insights about my path with others.</p>
            <p className={cx('manifesto')}>There's no one place I can go and figure out how I get from where I am today to where I want to be tomorrow.</p>
            <p className={cx('manifesto')}>There's no one place I can go to do all of this. But there should be, so that's what we're building.</p>
